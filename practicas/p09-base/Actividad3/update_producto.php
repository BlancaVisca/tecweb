...
if (mysqli_query($link, $sql_actualizar)) {
    ...
    echo '<a href="get_productos_vigentes_v2.php">ver cambios en productos existentes</a>'."<br>";
    echo '<a href="get_productos_xhtml_v2.php">ver cambios en productos generales</a>'."<br>";
